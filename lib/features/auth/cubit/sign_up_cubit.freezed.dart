...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'SignUpState(email: $email, password: $password, status: $status, showPassword: $showPassword, isEmailValid: $isEmailValid, isPasswordValid: $isPasswordValid)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, email, password, status,
      showPassword, isEmailValid, isPasswordValid);
